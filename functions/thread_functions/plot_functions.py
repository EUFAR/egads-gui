    ...
    def run(self):
        ...
        if self.plot_dict['georeferenced']:
            ...
            if self.plot_options['labels']:
                gl.xlabels_top = self.plot_options['labels_top']
                gl.xlabels_bottom = self.plot_options['labels_bottom']
                gl.ylabels_right = self.plot_options['labels_right']
                gl.ylabels_left = self.plot_options['labels_left']
