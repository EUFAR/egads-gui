...
def objects_initialization(self):
    ...
    self.buttons_lines_dict = {
                        ...
                        "new_button_1":["new_varName_ln", self.new_variable_list, self.list_of_new_variables_and_attributes],
                        "new_button_2":["new_longName_ln", self.new_variable_list, self.list_of_new_variables_and_attributes],
                        "new_button_3":["new_category_ln", self.new_variable_list, self.list_of_new_variables_and_attributes],
                        "new_button_4":["new_units_ln", self.new_variable_list, self.list_of_new_variables_and_attributes]
                        }
...
def setup_fonts(self):
    if platform.system() == 'Linux':
        ...
        font_list = [matplotlib.font_manager.FontProperties(fname=fname).get_name() for fname in matplotlib.font_manager.win32InstalledFonts()]
    else:
    ...
    default_font = matplotlib.font_manager.FontProperties(family=[str(matplotlib.rcParams['font.family'][0])]).get_name()
