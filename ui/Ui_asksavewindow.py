...
"}")
        self.gridLayout_2 = QtWidgets.QGridLayout(asksaveWindow)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setSpacing(0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scroll_area = QtWidgets.QScrollArea(asksaveWindow)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 603, 184))
...
"}")
        ...
        spacerItem5 = QtWidgets.QSpacerItem(20, 11, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
    ...
    def retranslateUi(self, asksaveWindow):
        ...
        self.label.setText(_translate("asksaveWindow", "<html><head/><body><p>The opened file has been modified in the workspace. Changes will be lost if the file is not saved.<br/></p><p><span style=\" font-weight:600;\">Do you want to save your changes ?</span></p></body></html>"))
