...
class Ui_mapextentWindow(object):
    def setupUi(self, mapextentWindow):
        ...
        mapextentWindow.resize(488, 332)
        mapextentWindow.setMinimumSize(QtCore.QSize(0, 0))
        mapextentWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.y_max_edit.setCursorPosition(0)
...
"}")
        ...
        self.x_min_edit.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.y_label_2.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
...
"}")
        ...
        self.x_max_edit.setAlignment(QtCore.Qt.AlignCenter)
...
"}")
        ...
        self.y_min_edit.setCursorPosition(0)
