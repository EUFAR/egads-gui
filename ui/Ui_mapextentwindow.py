...
class Ui_mapextentWindow(object):
    def setupUi(self, mapextentWindow):
        ...
        mapextentWindow.resize(476, 306)
        mapextentWindow.setMinimumSize(QtCore.QSize(476, 306))
        mapextentWindow.setMaximumSize(QtCore.QSize(476, 306))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.y_label_2.setMinimumSize(QtCore.QSize(0, 0))
        self.y_label_2.setMaximumSize(QtCore.QSize(300, 159))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setKerning(True)
...
"}")
        ...
        self.y_label_2.setPixmap(QtGui.QPixmap("images/mapmonde.jpg"))
