...
class Ui_updateAvailableWindow(object):
    def setupUi(self, updateAvailableWindow):
        updateAvailableWindow.setObjectName("updateAvailableWindow")
        updateAvailableWindow.resize(520, 223)
        updateAvailableWindow.setMinimumSize(QtCore.QSize(0, 0))
        updateAvailableWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("FreeSans")
        font.setPointSize(10)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        updateAvailableWindow.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/info_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        updateAvailableWindow.setWindowIcon(icon)
        updateAvailableWindow.setStyleSheet("QWidget {\n"
"    background-color: rgb(230,230,230);\n"
"}")
        self.gridLayout = QtWidgets.QGridLayout(updateAvailableWindow)
        self.gridLayout.setObjectName("gridLayout")
        self.dw_label_1 = QtWidgets.QLabel(updateAvailableWindow)
...
"}")
        ...
        self.dw_downloadButton = QtWidgets.QToolButton(updateAvailableWindow)
...
"}")
        ...
        self.dw_downloadButton_2 = QtWidgets.QToolButton(updateAvailableWindow)
...
"}")
        ...
        self.dw_okButton = QtWidgets.QToolButton(updateAvailableWindow)
...
"}")
        ...
        self.retranslateUi(updateAvailableWindow)
        QtCore.QMetaObject.connectSlotsByName(updateAvailableWindow)

    def retranslateUi(self, updateAvailableWindow):
        _translate = QtCore.QCoreApplication.translate
        updateAvailableWindow.setWindowTitle(_translate("updateAvailableWindow", "Information"))
        self.dw_label_1.setText(_translate("updateAvailableWindow", "<html><head/><body><p>A new version of the EGADS GUI is available on GitHub. Click on <span style=\" font-weight:600;\">Download update</span> to download it, or click on <span style=\" font-weight:600;\">Visit GitHub</span> to have a look at the EGADS GUI repository on GitHub.</p></body></html>"))
        self.dw_downloadButton.setText(_translate("updateAvailableWindow", "Download update"))
        self.dw_downloadButton_2.setText(_translate("updateAvailableWindow", "Visit GitHub"))
        self.dw_okButton.setText(_translate("updateAvailableWindow", "Ok"))
