...
"}")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(13, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
...
"}")
        ...
        spacerItem7 = QtWidgets.QSpacerItem(14, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
...
"}")
        ...
        self.checkbox_2 = QtWidgets.QCheckBox(optionWindow)
...
"}")
        ...
        self.horizontalLayout_8.addWidget(self.info_button_4)
        ...
        self.checkbox_3 = QtWidgets.QCheckBox(optionWindow)
...
"}")
        ...
        self.horizontalLayout_10.addWidget(self.info_button_5)
        ...
        self.checkbox_4 = QtWidgets.QCheckBox(optionWindow)
...
"}")
        ...
        spacerItem18 = QtWidgets.QSpacerItem(13, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
...
"}")
        ...
        spacerItem19 = QtWidgets.QSpacerItem(14, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
...
"}")
        ...
        self.horizontalLayout_6.addWidget(self.info_button_3)
        ...
        spacerItem25 = QtWidgets.QSpacerItem(138, 8, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_2.addItem(spacerItem25, 14, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, optionWindow):
        ...
        self.label_3.setText(_translate("optionWindow", "Log options:"))
        ...
        self.label_4.setText(_translate("optionWindow", "System options:"))
        self.checkbox_2.setText(_translate("optionWindow", "Read variables as float"))
        self.checkbox_3.setText(_translate("optionWindow", "Replace automatically missing values in variables by NaN"))
        self.checkbox_4.setText(_translate("optionWindow", "Do not replace missing values if a variable can\'t be read."))
        self.label_5.setText(_translate("optionWindow", "Update options:"))
        self.checkbox_1.setText(_translate("optionWindow", "Check EGADS Lineage GUI updates on GitHub at startup"))
