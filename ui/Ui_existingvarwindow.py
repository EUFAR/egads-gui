...
class Ui_existingvarWindow(object):
    def setupUi(self, existingvarWindow):
        ...
        existingvarWindow.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/info_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        existingvarWindow.setWindowIcon(icon)
        existingvarWindow.setStyleSheet("QWidget {\n"
...
"}")
        ...
        self.overwrite_button.setMaximumSize(QtCore.QSize(100, 27))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.overwrite_button.setFont(font)
        self.overwrite_button.setStyleSheet("QToolButton {\n"
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.overwrite_button)
        spacerItem2 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem2)
        self.cancel_button = QtWidgets.QToolButton(existingvarWindow)
...
"}")
        ...
        QtCore.QMetaObject.connectSlotsByName(existingvarWindow)
