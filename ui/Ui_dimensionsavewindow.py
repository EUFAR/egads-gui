...
# Form implementation generated from reading ui file 'dimensionsavewindow.ui'
#
...
class Ui_dimensionsaveWindow(object):
    def setupUi(self, dimensionsaveWindow):
        dimensionsaveWindow.setObjectName("dimensionsaveWindow")
        dimensionsaveWindow.resize(668, 293)
        dimensionsaveWindow.setMinimumSize(QtCore.QSize(0, 0))
        dimensionsaveWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        dimensionsaveWindow.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/warning_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        dimensionsaveWindow.setWindowIcon(icon)
        dimensionsaveWindow.setStyleSheet("QWidget {\n"
...
"  bottom: -1px;\n"
"}")
        self.gridLayout_2 = QtWidgets.QGridLayout(dimensionsaveWindow)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setVerticalSpacing(0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scroll_area = QtWidgets.QScrollArea(dimensionsaveWindow)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 668, 240))
...
"}")
        ...
        self.save_button = QtWidgets.QToolButton(dimensionsaveWindow)
...
"}")
        ...
        self.cancel_button = QtWidgets.QToolButton(dimensionsaveWindow)
...
"}")
        ...
        self.retranslateUi(dimensionsaveWindow)
        QtCore.QMetaObject.connectSlotsByName(dimensionsaveWindow)

    def retranslateUi(self, dimensionsaveWindow):
        _translate = QtCore.QCoreApplication.translate
        dimensionsaveWindow.setWindowTitle(_translate("dimensionsaveWindow", "Warning"))
        self.label.setText(_translate("dimensionsaveWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.save_button.setText(_translate("dimensionsaveWindow", "Save"))
        self.cancel_button.setText(_translate("dimensionsaveWindow", "Cancel"))
