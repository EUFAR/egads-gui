...
class Ui_coefWindow(object):
    def setupUi(self, coefWindow):
        coefWindow.setObjectName("coefWindow")
        coefWindow.resize(416, 343)
        coefWindow.setMinimumSize(QtCore.QSize(0, 0))
        coefWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        coefWindow.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/info_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        coefWindow.setWindowIcon(icon)
        coefWindow.setStyleSheet("QWidget {\n"
...
"}")
        ...
        self.label_1 = QtWidgets.QLabel(coefWindow)
...
"}")
        ...
        self.combobox = QtWidgets.QComboBox(coefWindow)
        self.combobox.setMinimumSize(QtCore.QSize(300, 27))
        self.combobox.setMaximumSize(QtCore.QSize(300, 27))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
...
"}")
    ...
    def retranslateUi(self, coefWindow):
        _translate = QtCore.QCoreApplication.translate
        coefWindow.setWindowTitle(_translate("coefWindow", "Coefficient"))
        self.label_1.setText(_translate("coefWindow", "If coefficient is present in variable list:"))
        self.label_2.setText(_translate("coefWindow", "If not:"))
        self.ok_button.setText(_translate("coefWindow", "Ok"))
        self.cancel_button.setText(_translate("coefWindow", "Cancel"))
