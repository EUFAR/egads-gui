...
class Ui_projectionWindow(object):
    def setupUi(self, projectionWindow):
        ...
        projectionWindow.resize(459, 287)
        projectionWindow.setMinimumSize(QtCore.QSize(0, 0))
        projectionWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        projectionWindow.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/info_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        projectionWindow.setWindowIcon(icon)
        projectionWindow.setStyleSheet("QWidget {\n"
...
"  bottom: -1px;\n"
"}")
        self.option_scroll.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.option_scroll.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        ...
        self.option_ok.setMaximumSize(QtCore.QSize(100, 27))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.option_ok.setFont(font)
        self.option_ok.setStyleSheet("QToolButton {\n"
...
"}")
        self.option_ok.setObjectName("option_ok")
        self.horizontalLayout_2.addWidget(self.option_ok)
        spacerItem2 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem2)
        self.option_cancel = QtWidgets.QToolButton(projectionWindow)
        self.option_cancel.setMinimumSize(QtCore.QSize(100, 27))
        self.option_cancel.setMaximumSize(QtCore.QSize(100, 27))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.option_cancel.setFont(font)
        self.option_cancel.setStyleSheet("QToolButton {\n"
"    border: 1px solid #acacac;\n"
"    border-radius: 1px;\n"
"    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, \n"
"                                stop: 0 #f0f0f0, stop: 1 #e5e5e5);\n"
...
"                                      stop: 0 #daecfc, stop: 1 #c4e0fc);\n"
"}")
        self.option_cancel.setObjectName("option_cancel")
        self.horizontalLayout_2.addWidget(self.option_cancel)
    ...
    def retranslateUi(self, projectionWindow):
        ...
        projectionWindow.setWindowTitle(_translate("projectionWindow", "Information"))
        self.option_ok.setText(_translate("projectionWindow", "Ok"))
        self.option_cancel.setText(_translate("projectionWindow", "Cancel"))
