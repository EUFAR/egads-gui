...
"}")
        ...
        self.cw_line_1.setStyleSheet("QLineEdit {\n"
"   border-radius: 3px;\n"
"   padding: 1px 4px 1px 4px;\n"
"   background-color: rgb(240, 240, 240);\n"
"   color: rgb(45,45,45);\n"
...
"}")
        ...
        self.cw_label_8.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
...
"}")
        ...
        self.cw_plain_4.setMinimumSize(QtCore.QSize(300, 200))
...
"}")
        ...
        self.gridLayout.addLayout(self.cw_input_vl, 1, 1, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem27, 2, 1, 1, 1)
        self.cw_scrollarea_1.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout_7.addWidget(self.cw_scrollarea_1, 3, 0, 1, 1)
        ...
        self.cw_label_2 = QtWidgets.QLabel(self.tab_3)
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(11)
        font.setKerning(True)
...
"}")
        ...
        self.gridLayout_6.addItem(spacerItem33, 2, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addItem(spacerItem35, 1, 0, 1, 1)
        self.cw_output_vl = QtWidgets.QVBoxLayout()
        self.cw_output_vl.setObjectName("cw_output_vl")
        self.gridLayout_2.addLayout(self.cw_output_vl, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem37, 2, 1, 1, 1)
...
"}")
    ...
    def retranslateUi(self, creationWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_1), _translate("creationWindow", "Algorithm"))
        self.cw_label_1.setText(_translate("creationWindow", "Click on the \'+\' button to add a new input"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("creationWindow", "Input(s)"))
        self.cw_label_2.setText(_translate("creationWindow", "Click on the \'+\' button to add a new output"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("creationWindow", "Output(s)"))
