...
"}")
        ...
        self.dw_label_4 = QtWidgets.QLabel(self.widget)
...
"}")
        ...
        self.dw_label_5 = QtWidgets.QLabel(self.widget)
...
"}")
        ...
        self.dw_table = QtWidgets.QTableWidget(self.widget)
...
"}")
    ...
    def retranslateUi(self, displayWindow):
        ...
        self.dw_label_3.setText(_translate("displayWindow", "Dimensions:"))
