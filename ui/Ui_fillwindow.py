...
"}")
    ...
    def retranslateUi(self, fillWindow):
        ...
        self.fw_label_1.setText(_translate("fillWindow", "<html><head/><body><p align=\"justify\">All mandatory fields have not been filled in. Actually, you have to complete all fields if you want to save the file.</p><p align=\"justify\">All fields which have not been completely filled in are indicated in <span style=\" font-weight:600; color:#c80000;\">red</span>.</p><p align=\"justify\"><span style=\" font-weight:600;\">Do not use an incomplete/incorrect algorithm for official processing.</span></p></body></html>"))
        self.fw_cancelButton.setText(_translate("fillWindow", "Ok"))
