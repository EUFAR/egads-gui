...
"}")
        ...
        self.layer_list.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.layer_list.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
...
"}")
    ...
    def retranslateUi(self, layerorderWindow):
        ...
        item.setText(_translate("layerorderWindow", "Background"))
